...
COMPANY = {
    ...
    'jobs_page_url': 'http://careers.peopleclick.com/careerscp/client_sourcefire/external/search.do',
    ...
    def scrape_job_links(self, url):
        ...
        while True:
            ...
            for a in s.findAll('a', href=r):
                ...
                if l.find('corporate headquarters') != -1:
                    l = self.parse_location('Columbia, MD')
                else:
