...
COMPANY = {
    ...
    'home_page_url': 'http://www.cleanharbors.com',
    'jobs_page_url': 'http://careers.peopleclick.com/careerscp/client_safetykleen/external_cleanharbors/search.do',

    'empcnt': [10001]
}

class CleanHarborsJobScraper(JobScraper):
    def __init__(self):
        super(CleanHarborsJobScraper, self).__init__(COMPANY)
