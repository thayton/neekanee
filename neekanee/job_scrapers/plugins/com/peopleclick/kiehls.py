...
COMPANY = {
    ...
    'home_page_url': 'http://www.kiehls.com',
    'jobs_page_url': 'https://careers.peopleclick.com/careerscp/client_thebodyshop/kiehls/search.do',

    'empcnt': [51,200]
}

class KiehlsJobScraper(JobScraper):
    def __init__(self):
        super(KiehlsJobScraper, self).__init__(COMPANY)
    ...
    def scrape_job_links(self, url):
        ...
        while True:
            ...
            for a in s.findAll('a', href=r):
                ...
                l = self.parse_location(td[-8].text)
                if not l:
                    continue
