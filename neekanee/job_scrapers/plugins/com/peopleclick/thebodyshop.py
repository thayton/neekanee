...
COMPANY = {
    ...
    'home_page_url': 'http://www.thebodyshop.com',
    'jobs_page_url': 'https://careers.peopleclick.com/careerscp/client_thebodyshop/external/en/search.do',

    'empcnt': [10001]
}

class TheBodyShopJobScraper(JobScraper):
    def __init__(self):
        super(TheBodyShopJobScraper, self).__init__(COMPANY)
