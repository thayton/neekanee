...
COMPANY = {
    ...
    'home_page_url': 'http://www.opentext.com',
    'jobs_page_url': 'https://careers.peopleclick.com/careerscp/client_miniro2/external_1/search.do',

    'empcnt': [5001,10000]
}

class OpenTextJobScraper(JobScraper):
    def __init__(self):
        super(OpenTextJobScraper, self).__init__(COMPANY)
