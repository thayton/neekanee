...
COMPANY = {
    ...
    'home_page_url': 'http://www.kindermorgan.com',
    'jobs_page_url': 'https://careers.peopleclick.com/careerscp/client_kindermorgan/external/search.do',

    'empcnt': [10001]
}

class KinderMorganJobScraper(JobScraper):
    def __init__(self):
        super(KinderMorganJobScraper, self).__init__(COMPANY)
