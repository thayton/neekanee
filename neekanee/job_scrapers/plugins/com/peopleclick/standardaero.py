...
COMPANY = {
    ...
    'home_page_url': 'http://www.standardaero.com',
    'jobs_page_url': 'http://careers.peopleclick.com/careerscp/client_standardaero/external/search.do',

    'empcnt': [1001,5000]
}

class StandardAeroJobScraper(JobScraper):
    def __init__(self):
        super(StandardAeroJobScraper, self).__init__(COMPANY)
