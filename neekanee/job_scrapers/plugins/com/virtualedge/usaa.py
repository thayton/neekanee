...
COMPANY = {
    ...
    'benefits': {
        'url': 'https://www.usaa.apply2jobs.com/profext/worklife.html',
        'vacation': [],
        'tuition_assistance': True
    },

    'home_page_url': 'http://www.usaa.com',
    'jobs_page_url': 'https://www.usaa.apply2jobs.com/profext/default.htm',
    ...
    def scrape_job_links(self, url):
        ...
        while True:
            ...
            for a in s.findAll('a', href=r):
                ...
                l = self.parse_location(td[2].text + ',' + td[3].text)
