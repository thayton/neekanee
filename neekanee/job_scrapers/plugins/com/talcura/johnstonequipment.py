...
COMPANY = {
    'name': 'Johnston Equipment',
    'hq': 'Mississauga, Canada',

    'home_page_url': 'http://www.johnstonequipment.com',
    'jobs_page_url': 'https://johnstonequipment.talcura.com/candidates/default.aspx?lang=en',

    'empcnt': [501,1000]
}

class JohnstonEquipmentJobScraper(JobScraper):
    def __init__(self):
        super(JohnstonEquipmentJobScraper, self).__init__(COMPANY)
...
def get_scraper():
    return JohnstonEquipmentJobScraper()
