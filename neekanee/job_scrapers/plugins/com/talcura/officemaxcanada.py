...
COMPANY = {
    'name': 'OfficeMax Grand & Toy',
    'hq': 'Toronto, Canada',

    'home_page_url': 'http://www.officemaxcanada.com',
    'jobs_page_url': 'https://grandtoy.talcura.com/candidates/Default.aspx?cmp=LPHRCAREERSHUBEN&DeptID=0&lang=en',
