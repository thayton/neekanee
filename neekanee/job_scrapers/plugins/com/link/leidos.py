...
COMPANY = {
    ...
    'home_page_url': 'http://www.leidos.com',
    'jobs_page_url': 'http://jobs.leidos.com',

    'empcnt': [10001]
}

class LeidosJobScraper(JobScraper):
    def __init__(self):
        super(LeidosJobScraper, self).__init__(COMPANY)
