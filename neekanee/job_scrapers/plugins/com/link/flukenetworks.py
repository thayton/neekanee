...
COMPANY = {
    ...
    'jobs_page_url': 'http://jobs.danaher.com/go/fluke-network-jobs/333684/',

    'empcnt': [501,1000]
}

class FlukeJobScraper(JobScraper):
    def __init__(self):
        super(FlukeJobScraper, self).__init__(COMPANY, return_usa_only=False)
