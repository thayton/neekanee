...
COMPANY = {
    ...
    'home_page_url': 'http://www.jnj.com',
    'jobs_page_url': 'http://jobs.jnj.com/search/',

    'empcnt': [10001]
}

class JnjJobScraper(JobScraper):
    def __init__(self):
        super(JnjJobScraper, self).__init__(COMPANY)
