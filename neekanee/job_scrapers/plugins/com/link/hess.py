...
COMPANY = {
    ...
    'home_page_url': 'http://www.hess.com',
    'jobs_page_url': 'http://jobs.hess.com/search/',

    'empcnt': [10001]
}

class HessJobScraper(JobScraper):
    def __init__(self):
        super(HessJobScraper, self).__init__(COMPANY)
