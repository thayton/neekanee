...
COMPANY = {
    ...
    'jobs_page_url': 'http://careers.marathonoil.com/search/',

    'empcnt': [1001,5000]
}

class MarathonOilJobScraper(JobScraper):
    def __init__(self):
        super(MarathonOilJobScraper, self).__init__(COMPANY, return_usa_only=False)
