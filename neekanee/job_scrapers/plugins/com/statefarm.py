...
COMPANY = {
    ...
    'benefits': {'vacation': [(0,10)]},

    'home_page_url': 'http://www.statefarm.com',
    'jobs_page_url': 'http://www.statefarm.com/careers/index_emp.asp',
...
class StateFarmJobScraper(JobScraper):
    ...
    def scrape_job_links(self, url):
        ...
        l = s.find(text='Search Jobs &amp; Apply')

        self.br.open(l.parent['href'])
