...
COMPANY = {
    ...
    'home_page_url': 'http://www.calfrac.com',
    'jobs_page_url': 'https://rn11.ultipro.com/CAL5001/JobBoard/SearchJobs.aspx',

    'empcnt': [1001,5000]
}

class CalfracJobScraper(JobScraper):
    def __init__(self):
        super(CalfracJobScraper, self).__init__(COMPANY)
