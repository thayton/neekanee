...
COMPANY = {
    ...
    'home_page_url': 'http://www.wpxenergy.com',
    'jobs_page_url': 'https://rn21.ultipro.com/WPX1000/JobBoard/SearchJobs.aspx?Page=Search',

    'empcnt': [1001,5000]
}

class WPXEnergyJobScraper(JobScraper):
    def __init__(self):
        super(WPXEnergyJobScraper, self).__init__(COMPANY)
