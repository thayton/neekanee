...
COMPANY = {
    ...
    'home_page_url': 'http://www.emdeon.com',
    'jobs_page_url': 'https://re21.ultipro.com/EMD1000/JobBoard/SearchJobs.aspx?Page=Search',

    'empcnt': [1001,5000]
}

class EmdeonJobScraper(JobScraper):
    def __init__(self):
        super(EmdeonJobScraper, self).__init__(COMPANY)
