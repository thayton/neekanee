...
COMPANY = {
    ...
    'home_page_url': 'http://www.doubleverify.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Jobs.aspx?c=qXc9VfwX',

    'empcnt': [51,200]
}

class DoubleVerifyJobScraper(JobScraper):
    def __init__(self):
        super(DoubleVerifyJobScraper, self).__init__(COMPANY)
