...
COMPANY = {
    'name': 'Red Frog Events',
    'hq': 'Chicago, IL',

    'ats': 'Jobvite',

    'home_page_url': 'http://www.redfrogevents.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?k=JobListing&c=qed9Vfwf&v=1',

    'empcnt': [51,200]
}

class RedFrogEventsJobScraper(JobScraper):
    def __init__(self):
        super(RedFrogEventsJobScraper, self).__init__(COMPANY)
...
def get_scraper():
    return RedFrogEventsJobScraper()
