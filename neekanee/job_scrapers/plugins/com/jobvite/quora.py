...
COMPANY = {
    ...
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qZ59VfwS',

    'empcnt': [1,10]
}

class QuoraJobScraper(JobScraper):
    def __init__(self):
        super(QuoraJobScraper, self).__init__(COMPANY)
