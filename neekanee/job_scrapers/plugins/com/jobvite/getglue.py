...
COMPANY = {
    ...
    'home_page_url': 'http://www.getglue.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=q0h9Vfw5',

    'empcnt': [11,50]
}

class GetGlueJobScraper(JobScraper):
    def __init__(self):
        super(GetGlueJobScraper, self).__init__(COMPANY)
