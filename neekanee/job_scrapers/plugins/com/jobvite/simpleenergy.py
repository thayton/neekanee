...
COMPANY = {
    ...
    'contact': 'jobs@SimpleEnergy.com',

    'home_page_url': 'http://www.simpleenergy.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?k=JobListing&c=qTb9VfwS&jvresize=http://utilities.simpleenergy.com/FrameResize.html',

    'empcnt': [1,10]
}

class SimpleEnergyJobScraper(JobScraper):
    def __init__(self):
        super(SimpleEnergyJobScraper, self).__init__(COMPANY)
