...
COMPANY = {
    ...
    'home_page_url': 'http://www.ted.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qC69Vfww',

    'empcnt': [201,500]
}

class TedJobScraper(JobScraper):
    def __init__(self):
        super(TedJobScraper, self).__init__(COMPANY)
