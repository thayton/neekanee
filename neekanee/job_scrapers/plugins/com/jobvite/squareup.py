...
COMPANY = {
    ...
    'home_page_url': 'https://squareup.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=q8Z9VfwV',

    'empcnt': [11,50]
}

class SquareUpJobScraper(JobScraper):
    def __init__(self):
        super(SquareUpJobScraper, self).__init__(COMPANY)
