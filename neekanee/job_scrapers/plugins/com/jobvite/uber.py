...
COMPANY = {
    ...
    'home_page_url': 'http://www.uber.com',
    'jobs_page_url': 'https://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qTd9VfwU',

    'empcnt': [11,50]
}

class UberJobScraper(JobScraper):
    def __init__(self):
        super(UberJobScraper, self).__init__(COMPANY)
