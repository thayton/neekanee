...
COMPANY = {
    ...
    'home_page_url': 'http://www.polyvore.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qN89VfwJ&k=JobListing&v=1',

    'empcnt': [1,10]
}

class PolyvoreJobScraper(JobScraper):
    def __init__(self):
        super(PolyvoreJobScraper, self).__init__(COMPANY)
