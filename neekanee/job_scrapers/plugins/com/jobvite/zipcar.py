...
COMPANY = {
    ...
    'home_page_url': 'http://www.zipcar.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qVl9Vfw4',

    'empcnt': [201,500]
}

class ZipCarJobScraper(JobScraper):
    def __init__(self):
        super(ZipCarJobScraper, self).__init__(COMPANY)
