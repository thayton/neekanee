...
COMPANY = {
    ...
    'jobs_page_url': 'https://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qAYaVfwn',

    'empcnt': [51,200]
}

class ExtraHopJobScraper(JobScraper):
    def __init__(self):
        super(ExtraHopJobScraper, self).__init__(COMPANY)
