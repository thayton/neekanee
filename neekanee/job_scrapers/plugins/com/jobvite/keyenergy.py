...
COMPANY = {
    ...
    'home_page_url': 'http://www.keyenergy.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qjb9Vfwi',

    'empcnt': [5001,10000]
}

class KeyEnergyJobScraper(JobScraper):
    def __init__(self):
        super(KeyEnergyJobScraper, self).__init__(COMPANY)
