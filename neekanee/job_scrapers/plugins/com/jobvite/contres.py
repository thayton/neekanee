...
COMPANY = {
    ...
    'home_page_url': 'http://www.contres.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qN29VfwD',

    'empcnt': [501,1000]
}

class ContresJobScraper(JobScraper):
    def __init__(self):
        super(ContresJobScraper, self).__init__(COMPANY)
