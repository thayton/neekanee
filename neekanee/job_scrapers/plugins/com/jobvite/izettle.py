...
COMPANY = {
    ...
    'home_page_url': 'http://www.izettle.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qo79Vfwj',

    'empcnt': [51,200]
}

class IzettleJobScraper(JobScraper):
    def __init__(self):
        super(IzettleJobScraper, self).__init__(COMPANY)
