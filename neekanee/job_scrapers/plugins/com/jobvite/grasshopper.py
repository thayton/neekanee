...
COMPANY = {
    ...
    'home_page_url': 'http://grasshopper.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?k=JobListing&c=qM79VfwH&jvresize=http%3a%2f%2fgrasshopper.com%2fassets%2fuploads%2fresize.html&v=1',

    'empcnt': [11,50]
}

class GrasshopperJobScraper(JobScraper):
    def __init__(self):
        super(GrasshopperJobScraper, self).__init__(COMPANY)
