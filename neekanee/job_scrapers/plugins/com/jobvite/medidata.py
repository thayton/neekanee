...
COMPANY = {
    ...
    'home_page_url': 'http://www.medidata.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qnh9Vfws&jvresize=http://www.mdsol.com/apndx/careers/FrameResize.html',

    'empcnt': [501, 1000]
}

class MedidataJobScraper(JobScraper):
    def __init__(self):
        super(MedidataJobScraper, self).__init__(COMPANY)
    ...
    def scrape_job_links(self, url):
        ...
        t = s.find('table', id='table_joblisting')
