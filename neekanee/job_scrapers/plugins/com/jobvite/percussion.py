...
COMPANY = {
    ...
    'home_page_url': 'http://www.percussion.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qG19Vfwv&jvresize=http://www.percussion.com/web_resources/themes/perc-web/FrameResize.html',

    'empcnt': [51,200]
}

class PercussionJobScraper(JobScraper):
    def __init__(self):
        super(PercussionJobScraper, self).__init__(COMPANY)
