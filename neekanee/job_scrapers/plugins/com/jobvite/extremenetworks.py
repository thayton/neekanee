...
COMPANY = {
    ...
    'home_page_url': 'http://www.extremenetworks.com',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qCx9VfwX&jvresize=/about-extreme/FrameResize.htm',

    'empcnt': [1001,5000]
}

class ExtremeNetworksJobScraper(JobScraper):
    def __init__(self):
        super(ExtremeNetworksJobScraper, self).__init__(COMPANY)
...
def get_scraper():
    return ExtremeNetworksJobScraper()
