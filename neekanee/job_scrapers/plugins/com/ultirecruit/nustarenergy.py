...
COMPANY = {
    ...
    'contact': 'HR@NuStarEnergy.com',

    'home_page_url': 'http://www.nustarenergy.com',
    'jobs_page_url': 'https://rn11.ultipro.com/val1002/jobboard/ListJobs.aspx',

    'empcnt': [1001,5000]
}

class NuStarEnergyJobScraper(JobScraper):
    def __init__(self):
        super(NuStarEnergyJobScraper, self).__init__(COMPANY)
