...
COMPANY = {
    'name': 'Parkway Properties',
    'hq': 'Jackson, MS',

    'ats': 'UltiRecruit',

    'home_page_url': 'http://www.pky.com',
    'jobs_page_url': 'https://www6.ultirecruit.com/PAR1013/JobBoard/SearchJobs.aspx',

    'empcnt': [201,500]
}

class PkyJobScraper(JobScraper):
    def __init__(self):
        super(PkyJobScraper, self).__init__(COMPANY)
