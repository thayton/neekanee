...
COMPANY = {
    ...
    'home_page_url': 'http://www.minervanetworks.com',
    'jobs_page_url': 'http://minerva.mycompas.com/corp/consol_careers/careers_source.aspx',

    'empcnt': [11,50]
}

# XXX similar to com/sendouts/cummins.py
class MinervaNetworksJobScraper(JobScraper):
    def __init__(self):
        super(MinervaNetworksJobScraper, self).__init__(COMPANY)
...
def get_scraper():
    return MinervaNetworksJobScraper()
