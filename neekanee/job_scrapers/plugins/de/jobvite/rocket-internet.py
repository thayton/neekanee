...
COMPANY = {
    ...
    'home_page_url': 'http://www.rocket-internet.de',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qEe9VfwG',

    'empcnt': [201,500]
}

class RocketInternetJobScraper(JobScraper):
    def __init__(self):
        super(RocketInternetJobScraper, self).__init__(COMPANY)
...
def get_scraper():
    return RocketInternetJobScraper()
