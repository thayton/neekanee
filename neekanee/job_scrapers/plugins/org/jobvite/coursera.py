...
COMPANY = {
    ...
    'home_page_url': 'http://www.coursera.org',
    'jobs_page_url': 'http://hire.jobvite.com/CompanyJobs/Careers.aspx?c=qui9VfwA',

    'empcnt': [1,10]
}

class CourseraJobScraper(JobScraper):
    def __init__(self):
        super(CourseraJobScraper, self).__init__(COMPANY)
