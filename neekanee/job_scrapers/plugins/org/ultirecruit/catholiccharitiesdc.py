...
COMPANY = {
    'name': 'Catholic Charities DC',
    'hq': 'Washington, DC',

    'ats': 'UltiRecruit',

    'home_page_url': 'http://www.catholiccharitiesdc.org',
    'jobs_page_url': 'https://re11.ultipro.com/ARC1012B/JobBoard/SearchJobs.aspx?Page=Search',

    'empcnt': [501,1000]
}

class CatholicCharitiesDcJobScraper(JobScraper):
    def __init__(self):
        super(CatholicCharitiesDcJobScraper, self).__init__(COMPANY)
...
def get_scraper():
    return CatholicCharitiesDcJobScraper()
