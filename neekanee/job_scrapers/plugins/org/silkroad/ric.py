...
COMPANY = {
    ...
    'home_page_url': 'http://www.ric.org',
    'jobs_page_url': 'https://ricc-hr.silkroad.com/epostings/index.cfm?version=1&company_id=16087',

    'empcnt': [1001,5000]
}

class RicJobScraper(JobScraper):
    def __init__(self):
        super(RicJobScraper, self).__init__(COMPANY)
