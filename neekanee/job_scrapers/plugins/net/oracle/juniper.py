...
COMPANY = {
    ...
    'home_page_url': 'http://www.juniper.net/',
    'jobs_page_url': 'https://careers.juniper.net',
...
class SandiaJobScraper(JobScraper):
    ...
    def scrape_job_links(self, url):
        ...
        b = '/psc/careers/EMPLOYEE/HRMS/c/HRS_HRAM.HRS_CE.GBL?Page=HRS_CE_JOB_DTL&Action=A&JobOpeningId=%d'
