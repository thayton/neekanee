...
COMPANY = {
    ...
    'home_page_url': 'http://www.sunymaritime.edu',
    'jobs_page_url': 'http://maritime.interviewexchange.com/static/clients/373SMM1/index.jsp',
...
#
class SunyMaritimeJobScraper(JobScraper):
    def __init__(self):
        super(SunyMaritimeJobScraper, self).__init__(COMPANY)
