...
COMPANY = {
    ...
    'home_page_url': 'http://www.necc.mass.edu',
    'jobs_page_url': 'http://necc.interviewexchange.com/static/clients/349NEM1/index.jsp',
...
#
class NeccJobScraper(JobScraper):
    def __init__(self):
        super(NeccJobScraper, self).__init__(COMPANY)
