...
COMPANY = {
    ...
    'home_page_url': 'http://www.rwu.edu',
    'jobs_page_url': 'http://rwu.interviewexchange.com/static/clients/420RWM1/index.jsp',
...
#
class RwuJobScraper(JobScraper):
    def __init__(self):
        super(RwuJobScraper, self).__init__(COMPANY)
